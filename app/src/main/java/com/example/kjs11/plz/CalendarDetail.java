...
public class CalendarDetail extends Activity implements OnClickListener { // 일정목록 추가하기
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout lin = (LinearLayout) findViewById(R.id.activity_calendar_detail);
